    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'white', color: 'black', fontFamily: 'sans-serif' }}>
      ...
      <aside style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '3rem' }}>
          ...
          <button style={largeButtonStyle}><FaHeadphones style={{ marginRight: '0.5rem' }} />Аудио курс</button>
          <button style={largeButtonStyle}><FaChartBar style={{ marginRight: '0.5rem' }} />Quizlet</button>
        </div>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <div style={{ display: 'flex', justifyContent: 'flex-end', padding: '1rem', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            {/* <input id="avatarInput" type="file" onChange={handleAvatarChange} style={{ marginTop: '0.5rem' }} /> */}
            {/* <button onClick={handleAvatarUpload} style={{ marginTop: '0.5rem', padding: '0.25rem 0.5rem', fontSize: '0.8rem' }}>Загрузить</button> */}
          </div>
        </div>
